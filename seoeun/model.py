...
def unimodel(datas,mode,norm,nepoch):
    ...
    if mode == 'audio':
        ...
        Audio_model.add(Bidirectional(LSTM(300, activation='tanh', dropout=0.5, name='Bi-LSTM_audio')))
        Audio_model.add(Dropout(0.5,name='Dropout1_audio'))
        Audio_model.add(Dense(500,activation='relu',name='Dense_audio'))
    ...
    if mode == 'text':
        ...
        Text_model.add(Bidirectional(LSTM(300, activation='tanh', dropout=0.5, name='Bi-LSTM_text')))
        Text_model.add(Dropout(0.5,name='Dropout1_text'))
        Text_model.add(Dense(500,activation='relu',name='Dense_text'))
